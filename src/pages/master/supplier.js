                ...
                <div className={style.content}>
                    <form id='form-data' className={global.card}>
                        ...
                        <div className={`${global.input_group_row}`}>
                            ...
                            <input type="text" className="col-12 col-lg-2 col-md-3" id='input-kode-supplier' name='input-kode-supplier' value={GenerateCode('SUP', this.state.dataSupplier)} maxLength={10} readOnly={true} required={true} />
                        </div>
                        <div className={`${global.input_group_row}`}>
                            <p className={`${global.title} col-12 col-lg-2 col-md-3`}>Nama Supplier <span className={global.important}>*</span></p>
                            <input type="text" className="col-12 col-md-8 col-lg-6" id='input-nama-supplier' name='input-nama-supplier' maxLength={50} required={true} />
                        </div>
                        <div className={`${global.input_group_row}`}>
                            <p className={`${global.title} col-12 col-lg-2 col-md-3`}>Alamat <span className={global.important}>*</span></p>
                            <input type="text" className="col-12 col-md-8 col-lg-6" id='input-alamat-supplier' name='input-alamat-supplier' maxLength={100} required={true} />
                        </div>
                        <div className={`${global.input_group_row}`}>
                            <p className={`${global.title} col-12 col-lg-2 col-md-3`}>No. Telp <span className={global.important}>*</span></p>
                            <input type="text" className="col-12 col-lg-3 col-md-6" id='input-telepon-supplier' name='input-telp-supplier' maxLength={13} onInput={InputFormatNumber} required={true} />
                        </div>
                        <div className={`${global.input_group_row}`}>
                            <p className={`${global.title} col-12 col-lg-2 col-md-3`}>No. Rek. Bank <span className={global.important}>*</span></p>
                            <input type="text" className="col-12 col-lg-3 col-md-6" id='input-rekening-supplier' name='input-rekening-supplier' maxLength={30} required={true} />
                        </div>

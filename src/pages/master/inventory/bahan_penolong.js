            ...
            <>
                ...
                <div className={style.content}>
                    ...
                    <p className={global.title}>Tambah Bahan Penolong</p>
                        ...
                        <div className={`${global.input_group}`}>
                            <p className={`${global.title} col-3`}>Harga</p>

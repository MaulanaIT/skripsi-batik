                    ...
                    <div className={`${global.card}`}>
                        ...
                        <div className={`d-flex`}>
                            ...
                            <div className={`${global.input_group} col-6 ps-2`}>
                                ...
                                <input type="date" id='input-tanggal' value={getValueTanggal} onChange={e => setValueTanggal(e.target.value)} />
                            </div>
                        </div>
                        <div className={`d-flex`}>
                        ...
                        <div className={`d-flex`}>
                            <div className={`${global.input_group} col-5 pe-2`}>
                                ...
                                <input type="text" id='input-kode-pesanan' value={getValueKodePesanan} readOnly={true} />
                            </div>
                            <div className={`${global.input_group} col-7 pe-2`}>
                                <p className={global.title}>Nama Pesanan</p>
                                <input type="text" id='input-nama-pesanan' value={getValueNamaPesanan} readOnly={true} />
                            </div>
                        </div>
                        <div className={`d-flex`}>
                            <div className={`${global.input_group} col-3 pe-2`}>
                ...
                <div className={`col-12 col-md-6 ps-md-2 pt-2 pt-md-0`}>
                    <div className={global.card}>
                        ...
                        <div className={`align-items-center ${global.input_group_row}`}>
                            ...
                            <input type="text" id='input-detail-ongkos-kirim' className={`col-4`} value={getValueOngkosKirim} onChange={e => setValueOngkosKirim(e.target.value)} />
                        </div>
                        <div className={`align-items-center ${global.input_group_row}`}>
                            <p className={`${global.title} col-3`}>Total Harga</p>
                            <input type="text" id='input-detail-total-harga' value={getValueKalkulasiTotalHarga} className={`col-4`} readOnly={true} />
                        </div>
                        <div className={`align-items-center ${global.input_group_row}`}>
                        ...
                        <div className={`align-items-center ${global.input_group_row}`}>
                            ...
                            <input type="text" id='input-sisa' className={`col-4`} value={getValueSisa} readOnly={true} />
                        </div>

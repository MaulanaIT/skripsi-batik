...
const Add_hpp = (props, ref) => {
    ...
    const AddDetailAlat = () => {
        ...
        let checkIndex = dataDetailAlat.findIndex(item => item.kode_alat === getValueKodeAlat.value);
    ...
    const AddDetailBahanBaku = () => {
        ...
        let checkIndex = dataDetailBahanBaku.findIndex(item => item.kode_bahan === getValueBahanBaku.value);
    ...
    const AddDetailPenolong = () => {
        ...
        let checkIndex = dataDetailPenolong.findIndex(item => item.kode_penolong === getValuePenolong.value);
    ...
    const AddDetailTenagaKerja = () => {
        ...
        let checkIndex = dataDetailTenagaKerja.findIndex(item => item.kode_tenaga_kerja === getValueKodeTenagaKerja.value);

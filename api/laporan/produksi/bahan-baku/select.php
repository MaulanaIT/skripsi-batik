...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // } else if ($jenis_laporan == 'bahan baku') {
        ...
        UNION ALL
        SELECT updated_at AS tanggal, 0 AS unit_masuk, 0 AS harga_masuk, jumlah AS unit_keluar, harga AS harga_keluar, 0 AS unit_saldo, 0 AS harga_saldo from hpp_detail_bahan_baku WHERE kode_bahan_baku = '".$kode_item."') a GROUP BY tanggal";
    // }
